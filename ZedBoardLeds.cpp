...
/**
 * Read all switches and writes the value to all LEDs
 *
 * - Calls ReadAllSwitches() to read all switches
 * - Calls WriteAllLeds() to write to the LEDs
 * @param None 
 * @return	None
 */
void ZedBoard::SwitchesToLeds()
{
	cout << "\nLoading LEDs with Switch Values\n" << endl;
